...
def auth_gate() -> None:
    ...
    ">
        ...
        <div style="
            ...
            background:#111;border-bottom:1px solid #1e293b;
            padding:6px 24px;
            display:flex;justify-content:space-between;align-items:center;
            font-family:'JetBrains Mono',Consolas,monospace;font-size:10px;
            color:#334155;letter-spacing:0.12em;z-index:9999;
        ">
            <span>REGARD TERMINALS &nbsp;·&nbsp; INTELLIGENCE SYSTEM v2.0</span>
            <span>{_date} &nbsp;·&nbsp; {_now}</span>
        </div>
        ...
        <div style="
            ...
            border-top:3px solid {COLORS['bloomberg_orange']};
            background:#111;
            padding:48px 48px 40px 48px;
            box-shadow:0 0 60px rgba(255,136,17,0.06);
        ">
            <!-- wordmark -->
            <div style="margin-bottom:32px;">
                ...
                <div style="
                    ...
                    color:#E0E0E0;letter-spacing:0.32em;
                    margin-left:4px;
                ">TERMINALS</div>
            </div>
            ...
            ">
                ...
                <div style="
                    font-family:'JetBrains Mono',Consolas,monospace;
                    font-size:9px;color:#334155;letter-spacing:0.2em;
            ...
            ">
                <div style="background:#111;padding:10px 12px;">
                    ...
                    <div style="font-family:'JetBrains Mono',Consolas,monospace;font-size:18px;font-weight:700;color:{COLORS['bloomberg_orange']};">8</div>
                </div>
                <div style="background:#111;padding:10px 12px;">
                    ...
                    <div style="font-family:'JetBrains Mono',Consolas,monospace;font-size:18px;font-weight:700;color:{COLORS['bloomberg_orange']};">17+</div>
                </div>
                <div style="background:#111;padding:10px 12px;">
            ...
            <div style="
                ...
                color:#334155;letter-spacing:0.08em;margin-bottom:36px;
                border-left:2px solid {COLORS['bloomberg_orange']};
            ...
            <div style="
                ...
                color:#334155;letter-spacing:0.2em;margin-bottom:12px;
            ">SECURE ACCESS</div>
    </div>
    </div>
    ...
    with col2:
        ...
        st.markdown(f"""<div style="
            ...
            font-family:'JetBrains Mono',Consolas,monospace;
            font-size:9px;color:#1e293b;letter-spacing:0.12em;
        ">REGARD TERMINALS &nbsp;·&nbsp; {_now} &nbsp;·&nbsp; AUTHORIZED USE ONLY</div>""",
        unsafe_allow_html=True)
    st.stop()
